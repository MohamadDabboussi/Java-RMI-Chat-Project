 ...
 * @author Mohamad
 */
public class Add_to_group extends javax.swing.JFrame {
    ...
    public Add_to_group(GroupImp g,int id_group,ArrayList<User> users) {
        initComponents();
        // fill list box
    ...
    private void initComponents() {
        ...
        jPanel1.add(BAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 140, 40));
    ...
    private void BAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BAddMouseClicked
        try {
            ...
            group.AddClient(groupId, u.getId());
        } catch (RemoteException ex) {
            Logger.getLogger(Add_to_group.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_to_group.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_to_group().setVisible(true);
            }
        });
    }
